...
ira_returns_income_cat_graph$variable <- str_replace(ira_returns_income_cat_graph$variable, "Num_of_Returns_clean_energy", "Residential Clean Energy Credit")
ira_returns_income_cat_graph$variable <- str_replace(ira_returns_income_cat_graph$variable, "Num_of_Returns_home_improvement", "Energy Efficicent Home Improvement Credit")
